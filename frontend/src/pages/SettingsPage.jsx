...
const THEMES = [
  {
    id: 'dark',
    name: 'Dark',
    description: 'The default. Easy on the eyes.',
    preview: ['#09090f', '#8b7cf8', '#4fd1a5'],
  },
  {
    id: 'midnight',
    name: 'Midnight',
    description: 'Deep blue-black. Late night sessions.',
    preview: ['#050d1a', '#60a5fa', '#34d399'],
  },
  {
    id: 'forest',
    name: 'Forest',
    description: 'Dark green tones. Calm and focused.',
    preview: ['#0a0f0a', '#4ade80', '#a3e635'],
  },
  {
    id: 'ocean',
    name: 'Ocean',
    description: 'Deep teal and cyan. Clean and cool.',
    preview: ['#060f14', '#22d3ee', '#818cf8'],
  },
  {
    id: 'light',
    name: 'Light',
    description: 'High contrast. For daylight use.',
    preview: ['#f8f8fc', '#6d52e8', '#0d9488'],
  },
]
...
const THEME_VARS = {
  dark: {
    ...
    '--accent-violet-dim':    'rgba(139,124,248,0.12)',
    '--accent-violet-border': 'rgba(139,124,248,0.25)',
    '--accent-teal':    '#4fd1a5',
    '--accent-teal-dim':'rgba(79,209,165,0.10)',
    '--accent-amber':   '#f0a05a',
    '--accent-amber-dim':'rgba(240,160,90,0.10)',
    '--accent-red':     '#f06a6a',
    '--accent-red-dim': 'rgba(240,106,106,0.10)',
  },
  midnight: {
    '--bg-base':    '#050d1a',
    '--bg-surface': '#091424',
    ...
    '--accent-violet-dim':    'rgba(96,165,250,0.12)',
    '--accent-violet-border': 'rgba(96,165,250,0.28)',
    '--accent-teal':    '#34d399',
    '--accent-teal-dim':'rgba(52,211,153,0.10)',
    '--accent-amber':   '#fbbf24',
  ...
  forest: {
    ...
    '--border-default': 'rgba(74,222,128,0.12)',
    '--border-strong':  'rgba(74,222,128,0.22)',
    '--accent-violet':        '#4ade80',
    '--accent-violet-dim':    'rgba(74,222,128,0.12)',
    '--accent-violet-border': 'rgba(74,222,128,0.28)',
    '--accent-teal':    '#a3e635',
    '--accent-teal-dim':'rgba(163,230,53,0.10)',
    '--accent-amber':   '#fde68a',
    '--accent-amber-dim':'rgba(253,230,138,0.10)',
    '--accent-red':     '#fca5a5',
    '--accent-red-dim': 'rgba(252,165,165,0.10)',
  },
  ocean: {
    '--bg-base':    '#060f14',
    '--bg-surface': '#0a1820',
    ...
    '--text-muted':     '#3d6878',
    '--border-subtle':  'rgba(34,211,238,0.07)',
    '--border-default': 'rgba(34,211,238,0.13)',
    '--border-strong':  'rgba(34,211,238,0.24)',
    '--accent-violet':        '#22d3ee',
    '--accent-violet-dim':    'rgba(34,211,238,0.12)',
    '--accent-violet-border': 'rgba(34,211,238,0.28)',
    '--accent-teal':    '#818cf8',
    '--accent-teal-dim':'rgba(129,140,248,0.10)',
    '--accent-amber':   '#fbbf24',
    '--accent-amber-dim':'rgba(251,191,36,0.10)',
    '--accent-red':     '#fb7185',
    '--accent-red-dim': 'rgba(251,113,133,0.10)',
  },
  light: {
    '--bg-base':    '#f8f8fc',
    '--bg-surface': '#ffffff',
    ...
    '--accent-violet':        '#6d52e8',
    '--accent-violet-dim':    'rgba(109,82,232,0.08)',
    '--accent-violet-border': 'rgba(109,82,232,0.22)',
    '--accent-teal':    '#0d9488',
